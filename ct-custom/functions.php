...
add_shortcode('coaliation-reach-us', 'coaliation_reach_us');
function coaliation_reach_us()
{
	ob_start();
	get_template_part('reach-us');
	return ob_get_clean();
}
...
function ct_custom_style() {
	wp_enqueue_style( 'style-override', get_template_directory_uri() . '/style-override.css', array(), '1.0.0' );
}
add_action( 'wp_enqueue_scripts', 'ct_custom_style' );
